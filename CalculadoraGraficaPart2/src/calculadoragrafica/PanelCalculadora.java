...
public class PanelCalculadora extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        ActionListener oyentePersonalizado = new OyentePersonalizado(campoNumero1,
                campoNumero2, grupoBotonesOperacion, etiquetaResultado);
        ...
        String[][] valores = {{"China", "29", "17", "16"},
        {"Estados Unidos", "22", "25", "17"},
        {"Japón", "17", "6", "10"}};

        JTable tablaMedallas = new JTable(valores, encabezados);
        JScrollPane jsp = new JScrollPane(tablaMedallas);
